...
export const metadata: Metadata = {
  title: "About",
  description: "About Sansa Group AB — a European consulting group with Sansavision (software/SaaS) and Grasp.im (robotics/annotation).",
};
...
export default function AboutPage() {
  return (
    <>
      <section className="mesh-bg px-5 pb-14 pt-36 md:pt-44">
        <div className="mx-auto max-w-[1000px]">
          <Reveal>
            ...
            <h1 className="mt-5 max-w-[22ch] text-[38px] font-semibold leading-[1.04] tracking-[-0.03em] text-white md:text-[56px]">
              A small senior group for big technical bets.
            </h1>
            <p className="mt-5 max-w-[62ch] text-[16px] leading-relaxed text-white/60">
              Sansa Group AB (sansagroup.eu) is a Stockholm-based consulting group.
      ...
      <section className="mx-auto max-w-[1000px] px-5 pb-24">
            ...
            <div className="grid gap-8 rounded-[calc(2rem-0.5rem)] bg-[#0a1118] p-8 md:grid-cols-2 md:p-10">
              <div>
                ...
                <p className="mt-3 text-[15px] leading-relaxed text-white/60">
                  ...
                  & SaaS subdivision. <strong className="text-white">Grasp.im</strong> is our
                  robotics & data-annotation practice. One contract, one lead, shared senior bench.
                </p>
              </div>
              <div className="space-y-3">
                {[
                  ...
                  ["Grasp.im", "Robotics & annotation practice", "/grasp"],
                ].map(([t, d, href]) => (
